...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    open func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error!) {
        if (error == nil) {
            ...
            if let tabBarVC = sb.instantiateViewController(withIdentifier: "tabBarView") as? UITabBarController {
    ...
    let googleMapsApiKey = "AIzaSyBOK7YCHAOittlORqY0IoMni_HC1Qh4U5M"
...
//    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "DoctorMap", withExtension: "momd")!
